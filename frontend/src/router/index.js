...
import UserEntitiesByUser from "../views/UserEntitiesByUser.vue";
import UserEntitiesByEntity from "../views/UserEntitiesByEntity.vue";
...
const routes = [
  ...
  { path: "/user-entity/user/:userId", component: UserEntitiesByUser },
  { path: "/user-entity/entity/:entityId", component: UserEntitiesByEntity },
